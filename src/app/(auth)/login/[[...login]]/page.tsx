...
import { Sparkles, ArrowRight, Mail, User, ShieldAlert } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    // Generate a consistent/valid mock user ID based on email prefix
    ...
    // Give a brief delay for a premium feedback feel
    setTimeout(() => {
      ...
      <div className="w-full max-w-md bg-slate-950/40 border border-slate-900 rounded-3xl p-8 backdrop-blur-xl shadow-2xl relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2 py-3 rounded-xl border border-slate-800 bg-slate-950/40 hover:bg-slate-950 hover:border-slate-700 text-slate-200 hover:text-white text-xs font-bold transition-smooth outline-none disabled:opacity-50 disabled:pointer-events-none"
          >
