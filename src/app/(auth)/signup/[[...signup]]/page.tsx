...
import { Sparkles, ArrowRight, Mail, User, ShieldAlert, GraduationCap, Briefcase, RefreshCw } from "lucide-react";
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#05050a] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-950/40 border border-slate-900 rounded-3xl p-8 backdrop-blur-xl shadow-2xl relative z-10 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Join the smart resume builder local demo space</p>
        </div>
        ...
        <div className="relative flex py-1 items-center">
          ...
          <span className="flex-shrink mx-3 text-[9px] uppercase font-bold tracking-widest text-slate-500">Or register with</span>
          <div className="flex-grow border-t border-slate-900/60" />
        </div>
