...
import { Sparkles, LogOut, Settings, X, Mail, User as UserIcon, Check } from "lucide-react";
...
export function AuthButton() {
              ...
              <div className="flex flex-col items-center space-y-3">
                ...
                <div className="text-center">
                  <span className="text-[10px] uppercase font-extrabold tracking-widest px-2 py-0.5 rounded-full bg-slate-950 border border-slate-900 text-slate-400">
                    {user.provider === "google" ? "Google Account" : user.provider === "apple" ? "Apple Account" : "Email Account"}
                  </span>
                </div>
              </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-950/60 border border-slate-900 text-slate-100 placeholder-slate-600 text-sm focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 outline-none transition-smooth disabled:opacity-50 disabled:pointer-events-none"
                    />
                  </div>
                </div>
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Link href="/signup">
        <button className="flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:opacity-95 transition-all duration-200 shadow-lg shadow-indigo-500/20">
